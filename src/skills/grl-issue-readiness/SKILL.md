...
- `gau-board` entra quando la issue tocca privacy, licenze, norme o rilascio.
...
`bmad-party-mode`, o `gau-board` se il primo non è installato — e si vede quante si chiudono con
