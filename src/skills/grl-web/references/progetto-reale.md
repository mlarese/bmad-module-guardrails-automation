...
Se un campo dice `non ancora`, quella cosa non è mai stata guardata: tieni il gate **per quel livello soltanto** prima di promuovere, passando a `gau-board` la pagina e il suo brief, la pagina per prima.
