...
Al gate di pagina passa a `gau-board` il percorso della pagina e quello del **suo** `brief.md`, con lo stesso ordine di lettura: prima la pagina a freddo, il brief dopo, per il confronto.
