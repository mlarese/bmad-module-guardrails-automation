...
Passagli i vincoli della memoria condivisa, che da solo non conosce: `accepted-risks.md` è una lista di silenzio, `decisions.md` sono dati e non proposte, la severità viene dal profilo. Chiedi la forma di `gau-board`: **un riepilogo unico e schematico**, nessun dialogo fra personaggi, disaccordi lasciati aperti.
...
Senza `bmad-party-mode`, convoca `gau-board` e dillo in una riga: coprirà meno ambiti.
