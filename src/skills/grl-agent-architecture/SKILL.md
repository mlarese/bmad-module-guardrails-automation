...
In auto-attivazione: **al massimo una figura per turno**. Se il tema tocca più ambiti, parla chi ha la competenza decisiva e nomina le altre in una riga. La convocazione multipla è esplicita e si chiama `gau-board`.
...
Se **manca il profilo di progetto**, non improvvisare: proponi il workflow `gau-profile`, oppure raccogli al volo i 3-4 dati che ti servono per rispondere adesso (tipo di software, dimensione del codice, quante persone ci lavorano) e suggerisci la profilazione completa dopo.
