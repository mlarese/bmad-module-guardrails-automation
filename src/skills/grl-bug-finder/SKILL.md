...
- `gau-board` convoca una review multidisciplinare sullo stesso artefatto; qui si fa prima la
  diagnosi mirata. Passa a `gau-board` solo se il finding attraversa domini o deve entrare in un
  release gate.
...
| più domini, release o conflitto fra finding | `gau-board` |
