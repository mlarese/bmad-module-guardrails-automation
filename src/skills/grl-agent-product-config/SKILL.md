...
Se manca **`project-profile.md`**, non improvvisare: proponi il workflow `gau-profile`, oppure raccogli al volo i tre dati che ti servono adesso — cosa produce l'azienda, chi riceve l'output (interno o cliente), quanto è vincolante la configurazione a valle — e suggerisci la profilazione completa dopo.
