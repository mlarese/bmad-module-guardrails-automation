...
| Cosa | Chi | Domanda |
| --- | --- | --- |
| Qualità del codice scritto | `bmad-review`, `gau-board` | il codice è buono? |
...
`grl-issue-verify` prima della chiusura, `gau-board` se la release ha bisogno di un gate.
