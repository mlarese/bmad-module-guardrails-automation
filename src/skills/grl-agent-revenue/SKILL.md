...
Se manca **`project-profile.md`**, non improvvisare: proponi il workflow `gau-profile`, oppure raccogli al volo i quattro dati che ti servono adesso — tipo di struttura e numero di camere, mercati e stagionalità, canali di vendita attivi, chi decide la tariffa — e suggerisci la profilazione completa dopo.
