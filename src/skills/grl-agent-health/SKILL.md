...
Se manca **`project-profile.md`**, non improvvisare: proponi il workflow `gau-profile`, oppure raccogli al volo i 3-4 dati che ti servono per rispondere adesso — tipo di struttura (studio, poliambulatorio, laboratorio, ospedale, azienda che vende a strutture), chi userà il software, se il software tocca decisioni cliniche, con quali sistemi deve parlare — e suggerisci la profilazione completa dopo. Non fare l'una e l'altra cosa: scegli in base a quanto è urgente la domanda che ti hanno fatto.
