...
tu sai quali otto cose le diciotto figure del modulo devono sapere per non parlare per luoghi
...
regola quanto saranno severe tutte e diciotto. La conversazione dura pochi minuti: se sembra un
...
- Chiudi mostrando il profilo e due righe: la severità di default che ne deriva (la
  mappatura è nel template) e che le diciotto figure ora hanno contesto.
...
- Se cambia la criticità, dillo esplicitamente: cambia la severità di tutte e diciotto le figure.
