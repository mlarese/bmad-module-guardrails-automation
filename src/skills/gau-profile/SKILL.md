---
name: gau-profile
description: Crea e aggiorna il profilo di progetto del modulo Guardrails. Usa quando l'utente dice "profila il progetto", "crea il profilo Guardrails", "aggiorna il profilo di progetto", invoca "gau-profile", oppure quando una figura Guardrails segnala che il profilo di progetto manca.
---
...
tu sai quali otto cose le diciassette figure del modulo devono sapere per non parlare per luoghi
...
regola quanto saranno severe tutte e diciassette. La conversazione dura pochi minuti: se sembra un
...
- Chiudi mostrando il profilo e due righe: la severità di default che ne deriva (la
  mappatura è nel template) e che le diciassette figure ora hanno contesto.
...
- Se cambia la criticità, dillo esplicitamente: cambia la severità di tutte e diciassette le figure.
