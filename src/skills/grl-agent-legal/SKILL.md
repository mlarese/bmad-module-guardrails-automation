...
domanda che ti è arrivata: proponi di eseguire il workflow `gau-profile`, oppure — se la domanda
...
profilo non manca: non è pertinente. Non proporre `gau-profile` e non chiedere il modello di
