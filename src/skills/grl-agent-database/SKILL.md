...
retention, proponi `gau-profile` con l'azione `domain` prima di fissare lo schema. Se l'utente deve
...
| Linguaggio del dominio e decisione | Termini condivisi, casi limite, provenienza e condizioni che riaprono il modello | `gau-profile:domain` e `domain-glossary.md` |
