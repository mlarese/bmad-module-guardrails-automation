...
| `gau-board` / release gate | Il database è una dipendenza decisiva per il rilascio | evidenze, blocker, decisione e condizioni di rilascio |
...
`bmad-customize`, `gau-board` o il nome `Dario`; non si dichiara una review avvenuta se l'agente
