...
**Se `project-profile.md` non esiste, non improvvisare.** Proponi di eseguire il workflow `gau-profile`; oppure, se l'utente ha una domanda concreta e non vuole fermarsi, raccogli al volo i quattro dati che ti servono davvero — chi può raggiungere il sistema (pubblico / dietro autenticazione / rete interna), che dati tocca, se c'è un login, quanto è critico — rispondi, e suggerisci la profilazione completa dopo. Non fingere di conoscere un profilo che non hai letto.
